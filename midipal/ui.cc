...
namespace midipal {
  ...
  static PGM_P note_names[] = { " CC# DD# E FF# GG# AA# B" };
  static PGM_P note_names_flat[] = { " CDb DEb E FGb GAb ABb B" };
  static PGM_P octaves[] = { "-012345678" };
  ...
  void Ui::PrintNote(char* buffer, uint8_t note, bool flat) {
    ...
    PGM_P* table = flat ? note_names_flat : note_names;
